...
for feature in layer[2].getFeatures():
    ...
    region = feature["CD_GEOCMI"]
    ##region = '31062'
    caminho = 'H:/02_PROJETOS_DADOS_QGIS/MG_ACESSIBILIDADE_HOSPITAIS/MICRO_'+region+'.gpkg'+'|'+'layername=MICRO_'+region
    ##Caminho resultado matriz - ORS Tools
    uri = 'H:/02_PROJETOS_DADOS_QGIS/MG_ACESSIBILIDADE_HOSPITAIS/MT_MICRO1.gpkg|layername=PROVISORIO'
    ...
    'INPUT_END_FIELD':'ID','INPUT_PROFILE':0,'OUTPUT':'ogr:dbname=\'H:/02_PROJETOS_DADOS_QGIS/MG_ACESSIBILIDADE_HOSPITAIS/MT_MICRO1.gpkg\' table=\"PROVISORIO\" (geom)'})
